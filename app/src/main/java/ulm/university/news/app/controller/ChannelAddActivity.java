...
public class ChannelAddActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        tilDescription.setLength(1, Constants.DESCRIPTION_MAX_LENGTH);

        tilDates.setNameAndHint(getString(R.string.channel_dates));
        tilDates.setLength(1, Constants.CHANNEL_DATES_MAX_LENGTH);

        tilLocations.setNameAndHint(getString(R.string.channel_locations));
        tilLocations.setLength(1, Constants.CHANNEL_LOCATIONS_MAX_LENGTH);

        tilWebsite.setNameAndHint(getString(R.string.channel_website));
        tilWebsite.setLength(1, Constants.CHANNEL_WEBSITE_MAX_LENGTH);
        ...
        tilAssistant.setLength(1, Constants.CHANNEL_CONTACTS_MAX_LENGTH);

        tilStartDate.setNameAndHint(getString(R.string.lecture_start_date));
        tilStartDate.setLength(1, Constants.CHANNEL_DATES_MAX_LENGTH);

        tilEndDate.setNameAndHint(getString(R.string.lecture_end_date));
        tilEndDate.setLength(1, Constants.CHANNEL_DATES_MAX_LENGTH);

        tilCost.setNameAndHint(getString(R.string.event_cost));
        tilCost.setLength(1, Constants.CHANNEL_COST_MAX_LENGTH);

        tilParticipants.setNameAndHint(getString(R.string.sports_participants));
        tilParticipants.setLength(1, Constants.CHANNEL_PARTICIPANTS_MAX_LENGTH);

        tilOrganizer.setNameAndHint(getString(R.string.event_organizer));
        tilOrganizer.setLength(1, Constants.CHANNEL_CONTACTS_MAX_LENGTH);
    ...
    public void onEventMainThread(Channel channel) {
        ...
        new ChannelDatabaseManager(this).storeChannel(channel);
